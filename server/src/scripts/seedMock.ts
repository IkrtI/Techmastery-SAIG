...
const BANKS: Record<MoodType, { a: string[]; b: string[] }> = {
  happy: {
    a: [
      ...
      'ได้ที่ฝึกงานที่เล็งไว้ตั้งแต่ปีหนึ่ง', 'ชนะบอร์ดเกมกับเพื่อนชมรม', 'ได้ของกินฟรีจากบูธหน้าตึก',
      'อาจารย์เลื่อนส่งงานให้อีกอาทิตย์', 'ฝนตกแต่กลับหอทันพอดี',
    ],
    b: [
  ...
  hyped: {
    a: [
      ...
      'อาจารย์ให้หัวข้อวิจัยที่อยากทำพอดี', 'เปิดรับสมัครแลกเปลี่ยนที่ญี่ปุ่นแล้ว', 'ได้บัตรคอนเสิร์ตมาแบบเฉียดฉิว', 'รุ่นพี่ชวนทำสตาร์ทอัพ',
      'คอมประกอบใหม่เพิ่งมาส่ง', 'ทีมชนะรอบคัดเลือกเมื่อคืน',
    ],
    b: [
  ...
  meh: {
    a: [
      ...
      'นั่งอ่านสไลด์วนไปวนมา', 'ตารางเรียนแน่นเท่าเดิม', 'ฝนตกทั้งวันไม่ได้ไปไหน', 'แอร์ห้องเรียนเย็นเกินไปอีกแล้ว',
      'ไวไฟหอช้าเหมือนเดิม', 'ต่อคิวโรงอาหารนานมาก',
    ],
    b: [
  ...
  tired: {
    a: [
      ...
      'ซ้อมพรีเซนต์ทั้งวันจนเสียงแหบ', 'เลิกแล็บตอนสองทุ่มกว่า', 'สอบเสร็จสองวิชาในวันเดียว', 'ยืนแล็บทั้งบ่ายไม่ได้นั่งเลย',
      'กลับหอดึกเพราะงานกลุ่ม', 'แบกโน้ตบุ๊กเดินทั้งวัน',
    ],
    b: [
  ...
  stressed: {
    a: [
      ...
      'เกรดเทอมนี้น่ากังวลมาก', 'หัวข้อโปรเจกต์ยังไม่ผ่านอาจารย์', 'ไฟล์งานหายก่อนส่งสองชั่วโมง', 'คอมค้างระหว่างเรนเดอร์งาน',
      'ลืมว่ามีควิซพรุ่งนี้เช้า', 'อีเมลหาอาจารย์ยังไม่ถูกตอบกลับ',
    ],
    b: [
  ...
  sad: {
    a: [
      ...
      'ทะเลาะกับเพื่อนร่วมทีมเรื่องงาน', 'รู้สึกตามเพื่อนในห้องไม่ทัน', 'แมวที่บ้านป่วยแต่กลับไปดูไม่ได้',
      'ของที่สั่งมาพังตั้งแต่แกะกล่อง', 'เกรดวิชาที่ชอบออกมาน่าผิดหวัง',
    ],
    b: [
